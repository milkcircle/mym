    ...
    echo "<tr>";
      ...
      echo "<td>";
        echo "<form action='medication_list.php' method='post'>";
          echo "<input type='submit' class='btn' value='details-$a_id'>Edit Details</button>";
          echo " ";
          echo "<input type='submit' class='btn' value='reminder-$a_id'>Reminders</button>";
          echo " ";
          echo "<input type='submit' class='btn' value='delete-$a_id'>Delete</button>";
        echo "</form>";
      echo "</td>";
